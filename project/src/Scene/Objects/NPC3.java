...
public class NPC3 extends SceneObject {
    ...
    public NPC3(Point4f origin, Point4f position, Vector4f scale, Vector4f rotation, HashMap<String, Texture> textures) {
...
//            System.out.println(walkStartTime);
    ...
    public void draw(Integer frame_delta) {
        ...
        GL11.glPushMatrix();
        {
            ...
            getTextures().get("blood_on_skin").bind();
            //Enable TEXTURE
            ...
            GL11.glPushMatrix();
            {
                ...
                //bind texture
                getTextures().get("blood_on_skin").bind(); //set texture
                //Enable TEXTURE
                GL11.glTexParameteri(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MAG_FILTER, GL_NEAREST);
                GL11.glTexParameteri(GL11.GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST);
                s2.DrawTexSphere();
