...
public class Player extends SceneObject {
    ...
    DisplayListTexSphere s2 = new DisplayListTexSphere(0.5f, 32, 32, getTextures().get("default_stone"));
    ...
    DisplayListTexSphere s9 = new DisplayListTexSphere(0.25f, 32, 32, getTextures().get("default_stone"));
    DisplayListTexSphere s10 = new DisplayListTexSphere(0.25f, 32, 32, getTextures().get("default_stone"));
    DisplayListTexSphere s11 = new DisplayListTexSphere(0.3f, 32, 32, getTextures().get("default_stone"));
    DisplayListTexSphere s12 = new DisplayListTexSphere(0.25f, 32, 32, getTextures().get("default_stone"));
    DisplayListTexSphere s13 = new DisplayListTexSphere(0.25f, 32, 32, getTextures().get("default_stone"));
    DisplayListTexSphere s14 = new DisplayListTexSphere(0.3f, 32, 32, getTextures().get("default_stone"));
    DisplayListTexSphere s15 = new DisplayListTexSphere(0.5f, 32, 32, getTextures().get("default_stone"));
    ...
    public void draw(Integer frame_delta) {
        ...
        GL11.glPushMatrix();
        {
            ...
            GL11.glPushMatrix();
            {
                ...
                //bind texture
                getTextures().get("wool_pink").bind(); //set texture
                //Enable TEXTURE
                GL11.glTexParameteri(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MAG_FILTER, GL11.GL_NEAREST);
                ...
                GL11.glPushMatrix();
                {
                    ...
                    GL11.glPushMatrix();
                    {
                        ...
                        GL11.glTexParameteri(
                                ...
                                GL11.GL_REPEAT);
                        Color.white.bind();
                        getTextures().get("abstract-green").bind(); //set texture
                        GL11.glTexParameteri(GL11.GL_TEXTURE_2D, GL11.GL_TEXTURE_MAG_FILTER, GL11.GL_NEAREST);
...
//                        sphere.DrawSphere(0.25f, 32, 32);
                ...
                GL11.glPushMatrix();
                {
                    ...
                    {
                        GL11.glTranslatef(0.0f, 0.0f, 0.0f);
                        glRotatef((float) (-LimbRotation / 1.5) + 90, 1.0f, 0.0f, 0.0f);
                        c6.DrawCylinder();
