...
public class BackgroundBox extends SceneObject {
    ...
    public BackgroundBox(Point4f origin, Point4f position, Vector4f scale) {
        super(origin, position, scale);
        init();
    }

    public BackgroundBox(Point4f origin, Point4f position, Vector4f scale, HashMap<String, Texture> textures) {
        super(origin, position, scale, textures);
        init();
    }

    public BackgroundBox(Point4f origin, Point4f position, Vector4f scale, Vector4f rotation, HashMap<String, Texture> textures) {
    ...
    public void draw(Integer delta) {
        ...
        getTextures().get("bgbox/Texture2024-down").bind();
        glCallList(face1);

        getTextures().get("bgbox/Texture2024-middle").bind();
        glCallList(face2);
        ...
        getTextures().get("bgbox/Texture2024-top").bind();
        glCallList(face6);
